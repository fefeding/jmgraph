 ...
 * 用于加载jmgraph主入口
 */
define("jmGraph/jmGraph/1.0.0/main-debug", [ "./common/jmUtils-debug", "./jmGraph-debug", "./models/jmGradient-debug", "./models/jmShadow-debug", "./common/jmEvents-debug", "./common/jmControl-debug", "./common/jmProperty-debug", "./common/jmObject-debug", "./shapes/jmPath-debug", "./shapes/jmShape-debug", "./shapes/jmLine-debug", "./shapes/jmBezier-debug", "./shapes/jmRect-debug", "./shapes/jmCircle-debug", "./shapes/jmArc-debug", "./shapes/jmHArc-debug", "./shapes/jmPrismatic-debug", "./controls/jmLabel-debug", "./controls/jmImage-debug", "./shapes/jmArraw-debug", "./controls/jmArrawLine-debug", "./controls/jmResize-debug", "./controls/jmTooltip-debug", "./editor/jmEditor-debug", "./editor/jmCell-debug", "./editor/jmConnectLine-debug" ], function(require, exports, module) {
    var jmUtils = require("./common/jmUtils-debug");
    var jmGraph = require("./jmGraph-debug");
    var jmEditor = require("./editor/jmEditor-debug");
    module.exports = {
        jmUtils: jmUtils,
        jmGraph: jmGraph,
        jmEditor: jmEditor
 ...
 * @static
 */
define("jmGraph/jmGraph/1.0.0/common/jmUtils-debug", [], function(require, exports, module) {
    var jmUtils = {
        version: "1.0.0"
    };
    module.exports = jmUtils;
    /**
     * 继承
     * 
     * @method extend
    ...
    jmUtils.extend = function(target, source) {
        if (typeof source === "function") {
            ...
            if (targetPrototype && targetPrototype.constructor != Object) {
                jmUtils.extend(F, targetPrototype);
            }
    ...
    jmUtils.apply = function(source, target) {
        if (typeof source == "object" && typeof target == "object") {
            for (var k in source) {
                ...
                if (t == "function") continue; else if (t == "object") {
                    if (!target[k] || typeof target[k] != "object") target[k] = {};
                    this.apply(source[k], target[k]);
                } else {
                    target[k] = source[k];
                }
            }
    ...
    jmUtils.isSupportedBrowser = function() {
        ...
        return !browser.msie || browser.ver > 8;
    };
    /**
     * 检查是否支持canvas或svg
    ...
    jmUtils.getEventPosition = function(evt, scale) {
        ...
        if (touches) evt = touches[0];
        //兼容touch事件
        var px = evt.pageX || evt.clientX + (document.documentElement.scrollLeft || document.body.scrollLeft);
        var py = evt.pageY || evt.clientY + (document.documentElement.scrollTop || document.body.scrollTop);
        var ox = evt.offsetX;
        var oy = evt.offsetY;
    ...
    jmUtils.formatDate = function(date, format) {
        ...
        var result = format.replace("yyyy", date.getFullYear().toString()).replace("MM", (date.getMonth() < 9 ? "0" : "") + (date.getMonth() + 1).toString()).replace("dd", (date.getDate() < 9 ? "0" : "") + date.getDate().toString()).replace("HH", (date.getHours() < 9 ? "0" : "") + date.getHours().toString()).replace("mm", (date.getMinutes() < 9 ? "0" : "") + date.getMinutes().toString()).replace("ss", (date.getSeconds() < 9 ? "0" : "") + date.getSeconds().toString());
        return result;
    };
});
 ...
 * @require jmControl
 */
define("jmGraph/jmGraph/1.0.0/jmGraph-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug", "jmGraph/jmGraph/1.0.0/common/jmEvents-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/shapes/jmLine-debug", "jmGraph/jmGraph/1.0.0/shapes/jmBezier-debug", "jmGraph/jmGraph/1.0.0/shapes/jmRect-debug", "jmGraph/jmGraph/1.0.0/shapes/jmCircle-debug", "jmGraph/jmGraph/1.0.0/shapes/jmArc-debug", "jmGraph/jmGraph/1.0.0/shapes/jmHArc-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPrismatic-debug", "jmGraph/jmGraph/1.0.0/controls/jmLabel-debug", "jmGraph/jmGraph/1.0.0/controls/jmImage-debug", "jmGraph/jmGraph/1.0.0/shapes/jmArraw-debug", "jmGraph/jmGraph/1.0.0/controls/jmArrawLine-debug", "jmGraph/jmGraph/1.0.0/controls/jmResize-debug", "jmGraph/jmGraph/1.0.0/controls/jmTooltip-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmGradient = require("jmGraph/jmGraph/1.0.0/models/jmGradient-debug");
    var jmShadow = require("jmGraph/jmGraph/1.0.0/models/jmShadow-debug");
    var jmEvents = require("jmGraph/jmGraph/1.0.0/common/jmEvents-debug");
    //依赖jmControl
    var jmControl = require("jmGraph/jmGraph/1.0.0/common/jmControl-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    var jmLine = require("jmGraph/jmGraph/1.0.0/shapes/jmLine-debug");
    var jmBezier = require("jmGraph/jmGraph/1.0.0/shapes/jmBezier-debug");
    var jmRect = require("jmGraph/jmGraph/1.0.0/shapes/jmRect-debug");
    var jmCircle = require("jmGraph/jmGraph/1.0.0/shapes/jmCircle-debug");
    var jmArc = require("jmGraph/jmGraph/1.0.0/shapes/jmArc-debug");
    var jmHArc = require("jmGraph/jmGraph/1.0.0/shapes/jmHArc-debug");
    var jmPrismatic = require("jmGraph/jmGraph/1.0.0/shapes/jmPrismatic-debug");
    var jmLabel = require("jmGraph/jmGraph/1.0.0/controls/jmLabel-debug");
    var jmImage = require("jmGraph/jmGraph/1.0.0/controls/jmImage-debug");
    var jmArraw = require("jmGraph/jmGraph/1.0.0/shapes/jmArraw-debug");
    var jmArrawLine = require("jmGraph/jmGraph/1.0.0/controls/jmArrawLine-debug");
    var jmResize = require("jmGraph/jmGraph/1.0.0/controls/jmResize-debug");
    var jmTooltip = require("jmGraph/jmGraph/1.0.0/controls/jmTooltip-debug");
    //定义图形类型缓存
    var __jmShapesCache = {};
 ...
 */
define("jmGraph/jmGraph/1.0.0/models/jmGradient-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
	 ...
	 */
    jmGradient.prototype.addColorStop = jmGradient.prototype.addStop = function(offset, color) {
        this.stops.add({
            offset: offset,
            color: color
        });
 ...
 */
define("jmGraph/jmGraph/1.0.0/models/jmShadow-debug", [], function(require, exports, module) {
 ...
 * @for jmGraph
 */
define("jmGraph/jmGraph/1.0.0/common/jmEvents-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
 ...
 * @for jmGraph
 */
define("jmGraph/jmGraph/1.0.0/common/jmControl-debug", [ "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    //依赖jmproperty
    var jmProperty = require("jmGraph/jmGraph/1.0.0/common/jmProperty-debug");
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmGradient = require("jmGraph/jmGraph/1.0.0/models/jmGradient-debug");
    var jmShadow = require("jmGraph/jmGraph/1.0.0/models/jmShadow-debug");
    function jmControl() {}
    module.exports = jmControl;
    //继承属性绑定
    ...
    jmControl.prototype.getLocation = function(reset) {
        ...
        var p = this.position();
        localtion.center = this.center && typeof this.center === "function" ? jmUtils.clone(this.center()) : null;
        //中心
        localtion.radius = this.radius ? this.radius() : null;
        //半径
        ...
        if (!this.parent) return localtion;
        //没有父节点则直接返回
    ...
    jmControl.prototype.raiseEvent = function(name, args) {
        ...
        if (!args.position) {
            ...
            var position = jmUtils.getEventPosition(args, graph.scaleSize);
            //初始化事件位置
        ...
        if (this.checkPoint(args.position)) {
            ...
            if (this.focused && name == "mousemove") {
                this.focused = false;
                //表明当前焦点离开
                runEventHandle.call(this, "mouseleave", args);
            }
        }
    ...
    jmControl.prototype.canMove = function(m, graph) {
            ...
            this.__mvMonitor.mv = function(evt) {
                ...
                if (_this.__mvMonitor.mouseDown) {
                    ...
                    if (_this.lockSide) {
                        ...
                        //检查边界出界
                        var outside = jmUtils.checkOutSide(parentbounds, thisbounds, {
                            x: offsetx,
                            y: offsety
                        });
                        if (outside.left < 0) {
        ...
        graph = graph || this.graph || this.findParent("jmGraph");
        //获取最顶级元素画布
        if (graph && m) {
 ...
 * @require jmObject
 */
define("jmGraph/jmGraph/1.0.0/common/jmProperty-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmObject = require("jmGraph/jmGraph/1.0.0/common/jmObject-debug");
    var jmProperty = function() {
        this.__properties = {};
        this.__eventHandles = {};
    };
    jmUtils.extend(jmProperty, jmObject);
    module.exports = jmProperty;
    /**
	 * 获取属性值
	 * 
	 * @method getValue
 ...
 * @for jmGraph
 */
define("jmGraph/jmGraph/1.0.0/common/jmObject-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    function jmObject() {}
    module.exports = jmObject;
    /**
	 * 检 查对象是否为指定类型
	 * 
	 * @method is
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmShape = require("jmGraph/jmGraph/1.0.0/shapes/jmShape-debug");
    ...
    jmUtils.extend(jmPath, jmShape);
    //继承基础图形
    module.exports = jmPath;
    /**
	 * 重写检查坐标是否在区域内
	 * 支持任意多边形
 ...
 * @module jmGraph
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmControl = require("jmGraph/jmGraph/1.0.0/common/jmControl-debug");
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmLine-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmLine, jmPath);
    //继承path图形
    module.exports = jmLine;
    /**
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmBezier-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmBezier, jmPath);
    //继承path图形
    module.exports = jmBezier;
    /**
	 * 初始化图形点
	 *
	 * @method initPoints
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmRect-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmRect, jmPath);
    //jmPath
    module.exports = jmRect;
    /**
	 * 获取当前控件的边界
	 *
	 * @method getBounds
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmCircle-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmCircle, jmPath);
    //继承path图形
    module.exports = jmCircle;
    /**
	 * 初始化图形点
	 * 
	 * @method initPoint
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmArc-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmArc, jmPath);
    //jmPath
    module.exports = jmArc;
    /**
	 * 初始化图形点
	 * 
	 * @method initPoint
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmHArc-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmHArc, jmPath);
    //jmPath
    module.exports = jmHArc;
    /**
	 * 初始化图形点
	 *
	 * @method initPoints
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmPrismatic-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmPrismatic, jmPath);
    //继承path图形
    module.exports = jmPrismatic;
    /**
	 * 初始化图形点
	 * 计算棱形顶点
	 * 
 ...
 */
define("jmGraph/jmGraph/1.0.0/controls/jmLabel-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmControl = require("jmGraph/jmGraph/1.0.0/common/jmControl-debug");
    function jmLabel(graph, params) {
        ...
        //文字垂直对齐
        style.textBaseline = style.textBaseline || "middle", this.graph = graph;
    ...
    jmUtils.extend(jmLabel, jmControl);
    //jmPath
    module.exports = jmLabel;
    /**
	 * 初始化图形点,主要用于限定控件边界。
	 *
	 * @method initPoints
    ...
    jmLabel.prototype.testSize = function() {
        //计算宽度
        var textSize = this.context.measureText ? this.context.measureText(this.value) : {
    ...
    jmLabel.prototype.width = function(w) {
        if (w) {
            ...
            if (w) return w; else if (this.context) {
 ...
 */
define("jmGraph/jmGraph/1.0.0/controls/jmImage-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmControl = require("jmGraph/jmGraph/1.0.0/common/jmControl-debug");
    ...
    jmUtils.extend(jmImage, jmControl);
    //继承基础图形
    module.exports = jmImage;
    /**
	 * 重写控件绘制
	 * 根据父边界偏移和此控件参数绘制图片
	 *
 ...
 */
define("jmGraph/jmGraph/1.0.0/shapes/jmArraw-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmUtils.extend(jmArraw, jmPath);
    //jmPath
    module.exports = jmArraw;
    /**
	 * 初始化图形点
	 * 
	 * @method initPoint
 ...
 */
define("jmGraph/jmGraph/1.0.0/controls/jmArrawLine-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    function jmArrawLine(graph, params) {
        ...
        this.start = params.start || (params.start = {
            x: 0,
            y: 0
        });
        this.end = params.end || (params.end = {
            x: 0,
            y: 0
        });
        this.initializing(graph.context, style);
    ...
    module.exports = jmArrawLine;
    jmUtils.extend(jmArrawLine, jmPath);
    //jmPath
    /**
	 * 初始化直线和箭头描点
	 *
 ...
 * @for jmGraph
 */
define("jmGraph/jmGraph/1.0.0/controls/jmResize-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmRect-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmRect = require("jmGraph/jmGraph/1.0.0/shapes/jmRect-debug");
    ...
    jmUtils.extend(jmResize, jmRect);
    //jmRect
    module.exports = jmResize;
    /**
	 * 初始化控件的8个拉伸方框
	 *
	 * @method init
 ...
 * @param {object} params 参数
 */
define("jmGraph/jmGraph/1.0.0/controls/jmTooltip-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmControl = require("jmGraph/jmGraph/1.0.0/common/jmControl-debug");
    ...
    jmUtils.extend(jmTooltip, jmControl);
    //jmPath
    module.exports = jmTooltip;
    /**
	 * 计算提示位并显示
	 * 
	 * @method draw
 ...
 */
define("jmGraph/jmGraph/1.0.0/editor/jmEditor-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/jmGraph-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug", "jmGraph/jmGraph/1.0.0/common/jmEvents-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/shapes/jmLine-debug", "jmGraph/jmGraph/1.0.0/shapes/jmBezier-debug", "jmGraph/jmGraph/1.0.0/shapes/jmRect-debug", "jmGraph/jmGraph/1.0.0/shapes/jmCircle-debug", "jmGraph/jmGraph/1.0.0/shapes/jmArc-debug", "jmGraph/jmGraph/1.0.0/shapes/jmHArc-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPrismatic-debug", "jmGraph/jmGraph/1.0.0/controls/jmLabel-debug", "jmGraph/jmGraph/1.0.0/controls/jmImage-debug", "jmGraph/jmGraph/1.0.0/shapes/jmArraw-debug", "jmGraph/jmGraph/1.0.0/controls/jmArrawLine-debug", "jmGraph/jmGraph/1.0.0/controls/jmResize-debug", "jmGraph/jmGraph/1.0.0/controls/jmTooltip-debug", "jmGraph/jmGraph/1.0.0/editor/jmCell-debug", "jmGraph/jmGraph/1.0.0/editor/jmConnectLine-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmProperty = require("jmGraph/jmGraph/1.0.0/common/jmProperty-debug");
    var jmGraph = require("jmGraph/jmGraph/1.0.0/jmGraph-debug");
    var jmCell = require("jmGraph/jmGraph/1.0.0/editor/jmCell-debug");
    var jmConnectLine = require("jmGraph/jmGraph/1.0.0/editor/jmConnectLine-debug");
    function jmEditor(option) {
        ...
        if (option.container) {
            ...
            this.graph = new jmGraph(option.container, option.width, option.height);
            //生成框选对象
            this.selectRect = this.graph.createShape("rect", {
                style: this.defaultStyle.selectRect
            });
    ...
    jmUtils.extend(jmEditor, jmProperty);
    //继承属性绑定
    module.exports = jmEditor;
    /**
	 * 编辑器默认样式
	 *
        ...
        cell.on("move", function(s) {
            ...
            if (s.trans === true) {
                ...
                for (var i = 0; i < cells.length; i++) {
                    if (cells[i] != this) {
                        cells[i].offset(s.offsetX, s.offsetY, false);
                    }
                }
            }
            _this.resize(this);
    ...
    jmEditor.prototype.initEvents = function() {
        ...
        this.graph.bind("mousedown", function(evt) {
            ...
            if (evt.button == 0 || evt.button == 1) {
                ...
                //开始框选
                _this.selectRect.position({
                    x: evt.position.offsetX,
                    y: evt.position.offsetY
                });
        ...
        jmUtils.bindEvent(document, "mouseup", function(evt) {
            ...
            if (_this.currentComponent) {
                ...
                if (evtpos.pageX >= pos.left && evtpos.pageX <= pos.left + _this.graph.canvas.width && evtpos.pageY >= pos.top && evtpos.pageY <= pos.top + _this.graph.canvas.height) {
            ...
            if (_this.selecting) {
                ...
                var p = _this.selectRect.position();
                var endp = {
                    x: p.x + _this.selectRect.width(),
                    y: p.y + _this.selectRect.height()
                };
                _this.cells.each(function(i, cell) {
                    var cp = cell.position ? cell.position() : cell.center ? cell.center() : {
                        x: 0,
                        y: 0
                    };
                    //如果节点的中心或位置点在框内。则选中
                    if (cp.x >= Math.min(p.x, endp.x) && cp.x <= Math.max(p.x, endp.x) && cp.y >= Math.min(p.y, endp.y) && cp.y <= Math.max(p.y, endp.y)) {
                        cell.select(true);
                    }
                });
                _this.graph.refresh();
	...
	*/
    ...
    jmEditor.prototype.redo = function() {
        ...
        //不可编辑时，直接退出
        //当前索引不为最后一个时方可恢复操作
        if (this.cacheIndex !== undefined && this.cacheIndex < this.caches.length - 1 && this.caches && this.caches.length > 0) {
                ...
                if (cell.outs) {
                    ...
                    for (var j in cell.outs) {
                        ...
                        if (o.to) {
                            ...
                            if (target) {
                                cur.connect(target, o.id, o.value);
                            }
                        }
                    }
                }
 ...
 */
define("jmGraph/jmGraph/1.0.0/editor/jmCell-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug", "jmGraph/jmGraph/1.0.0/editor/jmConnectLine-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmControl = require("jmGraph/jmGraph/1.0.0/common/jmControl-debug");
    var jmConnectLine = require("jmGraph/jmGraph/1.0.0/editor/jmConnectLine-debug");
    ...
    jmUtils.extend(jmCell, jmControl);
    //继承属性绑定
    module.exports = jmCell;
    /**
	 * 初始化当前元素样式
	 *
	 * @method setStyle
    ...
    jmCell.prototype.setStyle = function(style) {
        if (style) {
            ...
            this.style.zIndex = this.style.zIndex || 1e3;
            this.fontStyle = mpstyle.fontStyle || this.editor.defaultStyle.font;
            this.style.padding = this.style.padding || {
                left: 8,
                top: 8,
                right: 8,
                bottom: 8
 ...
 */
define("jmGraph/jmGraph/1.0.0/editor/jmConnectLine-debug", [ "jmGraph/jmGraph/1.0.0/common/jmUtils-debug", "jmGraph/jmGraph/1.0.0/shapes/jmPath-debug", "jmGraph/jmGraph/1.0.0/shapes/jmShape-debug", "jmGraph/jmGraph/1.0.0/common/jmControl-debug", "jmGraph/jmGraph/1.0.0/common/jmProperty-debug", "jmGraph/jmGraph/1.0.0/common/jmObject-debug", "jmGraph/jmGraph/1.0.0/models/jmGradient-debug", "jmGraph/jmGraph/1.0.0/models/jmShadow-debug" ], function(require, exports, module) {
    var jmUtils = require("jmGraph/jmGraph/1.0.0/common/jmUtils-debug");
    var jmPath = require("jmGraph/jmGraph/1.0.0/shapes/jmPath-debug");
    ...
    jmConnectLine.prototype.getPoints = function(start, end) {
        ...
        function getDirection(s, e) {
            ...
            if (s.x > e.x) {
                return s.y > e.y ? 3412 : 3214;
            } else {
                return s.y > e.y ? 1432 : 1234;
            }
        }
        var xOffset = 30;
        var yOffset = 30;
        ...
        if (start == this.from.pos1) {
              ...
              case this.to.pos2:
                {
                    var p1 = {
                        x: start.x,
                        y: Math.min(start.y - yOffset, end.y - yOffset)
                    };
                    points.push(p1);
                    break;
                }
            ...
            switch (end) {
              ...
              case this.to.pos3:
                {
                    var p1 = {
                        x: Math.max(start.x + xOffset, end.x + xOffset),
                        y: start.y
                    };
                    points.push(p1);
                    var p2 = {
              ...
              case this.to.pos2:
                {
                    var p1 = {
                        x: start.x,
                        y: Math.max((end.y - start.y) / 2 + start.y, end.y - yOffset)
                    };
                    points.push(p1);
                    var p2 = {
                        x: end.x,
              ...
              case this.to.pos4:
                {
                    var p1 = {
                        x: start.x,
                        y: Math.max(start.y + xOffset, end.y + xOffset)
                    };
                    points.push(p1);
                    var p2 = {
                        x: end.x,
