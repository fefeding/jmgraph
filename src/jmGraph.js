...
define(function(require,exports,module) {
	...
	var jmGradient = require('./models/jmGradient');
	var jmShadow = require('./models/jmShadow');
	var jmEvents = require('./common/jmEvents');
	//依赖jmControl
	var jmControl = require('./common/jmControl');
	var jmPath = require('./shapes/jmPath');
	var jmLine = require('./shapes/jmLine');
	var jmBezier = require('./shapes/jmBezier');
	var jmRect = require('./shapes/jmRect');
	var jmCircle = require('./shapes/jmCircle');
	var jmArc = require('./shapes/jmArc');
	var jmHArc = require('./shapes/jmHArc');
	var jmPrismatic = require('./shapes/jmPrismatic');
	var jmLabel = require('./controls/jmLabel');
	var jmImage = require('./controls/jmImage');
	var jmArraw = require('./shapes/jmArraw');
	var jmArrawLine = require('./controls/jmArrawLine');
	var jmResize = require('./controls/jmResize');
	var jmTooltip = require('./controls/jmTooltip');
